    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto relative min-h-[400px]">
          ...
          {collections.map((c, i) => (
            <Link to="/shop" key={c._id} className="group relative rounded-3xl overflow-hidden border border-border bg-card shadow-soft hover:shadow-brand transition-all hover:-translate-y-1">
